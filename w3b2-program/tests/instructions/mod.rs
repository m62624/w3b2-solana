...
use w3b2_program::{accounts as w3b2_accounts, instruction as w3b2_instruction};
...
const PATH_SBF: &str = "../target/deploy/w3b2_program.so";
...
pub fn setup_svm() -> LiteSVM {
    ...
    svm.add_program_from_file(w3b2_program::ID, PATH_SBF)
        .unwrap();
    svm
}
